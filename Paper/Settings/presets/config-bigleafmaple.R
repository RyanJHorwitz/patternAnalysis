...
drop_version <- NA
data_selection <- "All"
study_area <- 'shapefiles/big_leaf_maple_shapefiles/study_area/Big_Leaf_subdivided.shp'
equalarea <- 'PROJCS["ProjWiz_Custom_Transverse_Cylindrical_Equal_Area",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Transverse_Cylindrical_Equal_Area"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",-121.8164063],PARAMETER["Scale_Factor",1.0],PARAMETER["Latitude_Of_Origin",0.0],UNIT["Meter",1.0]]'
equidistant <- 'PROJCS["ProjWiz_Custom_Cassini",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Cassini"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",-121.8164063],PARAMETER["Scale_Factor",1.0],PARAMETER["Latitude_Of_Origin",0.0],UNIT["Meter",1.0]]'
adjustments <- 1:5
constraint_paths <- c(paste0('shapefiles/big_leaf_maple_shapefiles/buffer/', species, '_100km_buffer.shp'), paste0('shapefiles/big_leaf_maple_shapefiles/buffer/', species, '_300km_buffer.shp'))
