...
# FILE: config-douglasfir-known-restricted.R
...
drop_version <- NA
data_selection <- "All"
study_area <- 'shapefiles/douglas_fir_shapefiles/study_area/Western_subdivided.shp'
equalarea <- 'PROJCS["ProjWiz_Custom_Albers",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Albers"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",-479.9267578],PARAMETER["Standard_Parallel_1",34.3294235],PARAMETER["Standard_Parallel_2",47.1337133],PARAMETER["Latitude_Of_Origin",40.7315684],UNIT["Meter",1.0]]' # input equalarea ====
equidistant <- 'PROJCS["ProjWiz_Custom_Equidistant_Conic",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Equidistant_Conic"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",-479.9267578],PARAMETER["Standard_Parallel_1",34.3294235],PARAMETER["Standard_Parallel_2",47.1337133],PARAMETER["Latitude_Of_Origin",40.7315684],UNIT["Meter",1.0]]' # input equidistant ====
adjustments <- 1:5
constraint_paths <- c(paste0('shapefiles/douglas_fir_shapefiles/buffer/', species, '_100km_buffer.shp'), paste0('shapefiles/douglas_fir_shapefiles/buffer/', species, '_300km_buffer.shp'))
center_selection <- "Weighted_Mean"
restriction <- c(43, 47)
additional_features <- T
...
# additional_features: Options ... FALSE or TRUE. If TRUE, plots Mt. Hebo on the output map.
